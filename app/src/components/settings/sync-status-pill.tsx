...
export function SyncStatusPill({
  ...
  return (
    <div className="rounded-full border border-border bg-background shadow-sm">
      <div className="flex h-8 items-center gap-1.5 px-3">
        <Button
          ...
          className="h-auto gap-1.5 px-1 py-0 text-xs text-muted-foreground shadow-none"
          title={
            !isOnline
              ? "Offline"
              : !isAuthed
        ...
        {!isAuthed && (
          <Button
            ...
            className="h-auto gap-1 px-1 py-0 text-xs text-muted-foreground shadow-none"
