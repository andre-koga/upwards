...
export default function StatsPage() {
  ...
  return (
    ...
    >
      ...
      {stats && (
        <div className="flex flex-col gap-2 lg:grid lg:grid-cols-[minmax(16rem,20rem)_minmax(0,1fr)] lg:items-start lg:gap-4">
          <aside className="order-3 flex flex-col gap-2 lg:sticky lg:top-4 lg:order-1">
            {stats.groups.length > 0 ? (
              ...
              <p className="py-6 text-center text-sm text-muted-foreground lg:py-0 lg:text-left">
                {t("createGroupHint")}
              </p>
            )}
          </aside>
